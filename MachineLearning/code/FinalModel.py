...
#model architecture - 1 hidden layer, drop out, relu, sgd and cross entropy loss.
...
# VALIDATION    
    ...
    if early_stopping.early_stop:
        ...
        break
model.load_state_dict(torch.load('checkpoint.pt')) #early stopping creates a checkpoint that we recover at the end of training/validation
